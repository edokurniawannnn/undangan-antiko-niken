...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    ...
    const data = new URLSearchParams({
      action: "TEMPLATE",
      text: "The Wedding of Antiko and Niken",
      dates: `${formatDate("2026-06-06 10:00")}/${formatDate("2026-06-06 11:00")}`,
      details:
      ...
      location: "Dsn. Jolotundo RT. 03 RW. 07, Ds. Jolotundo Kec. Jetis Kab. Mojokerto Jawa Timur",
      ctz: config.get("tz"),
    });
  ...
  const booting = async () => {
    ...
    if (presence && information.has("presence")) {
